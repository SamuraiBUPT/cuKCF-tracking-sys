...
class Params {
  public:
    ...
    // Scale
    bool use_dsst =
        true; // This module is the tool for DSST and we use cv::dft instead of fftw for simplicity and convenience
...
extern int num_threads; // use omp, set the number of threads
