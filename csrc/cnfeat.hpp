...
class CNFeat {
  ...
  private:
    inline static int rgb2id(int r, int g, int b) { return (r >> 3) + 32 * (g >> 3) + 32 * 32 * (b >> 3); }
    static const int p_cn_channels = 10;
    static float p_id2feat[32768][10]; // 32768 = 2^15, 10 = number of channels, will be defined in cpp file
};
